...
namespace BitkiFirmasi
{
    partial class Form6
    {
        ...
        private void InitializeComponent()
        {
            ...
            "Hangi Bitki Cinsinden Kaç Tane Satılmış",
            "Hangi Çalışan Kaçtane Satış Yapmış",
            "Çalışanlar Ve Siparişler",
            "Bitkilerin İdeal Sıcaklıkları Ve Nemleriyle Bulundukları Depoların Anlık Sıcaklık" +
                " Ve Nemleri",
            "Diğer..."});
            this.comboBox2.Location = new System.Drawing.Point(108, 68);
